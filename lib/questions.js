...
const questions = [
    ...
    // text Colorhexadecimal
    {
        type: "input",
        name: "logoTxtColor",
        message: "Enter the text color hexadecimal number (#CCCCCC): ",
        when: (answer) => {
    ...
    //  Shape Color keyword
    {
        type: "input",
        name: "logoShapeColor",
        message: "Enter the Logo Shape color keyword: ",
        when: (answer) => {
    ...
    //  Shape Color hexadecimal
    {
        type: "input",
        name: "logoShapeColor",
        message: "Enter the Logo Shape color hexadecimal number (#CCCCCC): ",
        when: (answer) => {
    ...
    //Logo file name Question (optional)
    {
        type: 'input',
        message: 'If applicable, Enter name of your Logo (AlphaNumeric only) :',
        name: 'logoName',
        default: 'logo',
        validate: function (answer) {
            if (answer != '') {
